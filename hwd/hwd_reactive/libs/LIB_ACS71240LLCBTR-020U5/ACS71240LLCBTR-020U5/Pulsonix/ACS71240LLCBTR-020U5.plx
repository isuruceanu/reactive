...
//18436224/178239/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ACS71240LLCBTR-020U5" (originalName "ACS71240LLCBTR-020U5")
	...
	(compDef "ACS71240LLCBTR-020U5" (originalName "ACS71240LLCBTR-020U5") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "__FAULT") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ACS71240LLCBTR-020U5"))
		...
		(attr "Mouser Part Number" "250-S71240LLCBTR020U")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Allegro-MicroSystems/ACS71240LLCBTR-020U5?qs=rQFj71Wb1eXatIJDjqEsyg%3D%3D")
		(attr "Manufacturer_Name" "Allegro Microsystems")
		(attr "Manufacturer_Part_Number" "ACS71240LLCBTR-020U5")
		(attr "Description" "Board Mount Current Sensors CURRENT SENSOR IC WITH COMMON MODE REJECTION AND OVERCURRENT FAULT")
		(attr "<Hyperlink>" "https://www.mouser.de/datasheet/2/1115/ACS71240_Datasheet-3079675.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ACS71240LLCBTR-020U5.stp")
